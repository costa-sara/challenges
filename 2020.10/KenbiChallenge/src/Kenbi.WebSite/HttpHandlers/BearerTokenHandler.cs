...
namespace Kenbi.WebSite.HttpHandlers
{
        ...
        public async Task<string> GetAccessTokenAsync()
        {
            ...
            var refreshResponse = await idpClient.RequestRefreshTokenAsync(
                new RefreshTokenRequest
                {
                    ...
                    ClientId = _configuration?.GetSection("IdentityServer")?.GetSection("ApiName").Value,
                    ClientSecret = _configuration?.GetSection("IdentityServer")?.GetSection("ApiSecret").Value,
